...
public class JPushUtil {
    ...
    public static final String KEY_MASTER_SECRET = "JPUSH_MASTERSECRET";
    ...
    public static String getMasterSecret(Context context) {
        ...
        try {
            ...
            if (null != ai)
                metaData = ai.metaData;
            if (null != metaData) {
            	masterSecret = metaData.getString(KEY_MASTER_SECRET);
                if ((null == masterSecret) || masterSecret.length() != 24) {
                	masterSecret = null;
                }
            }
        } catch (NameNotFoundException e) {
